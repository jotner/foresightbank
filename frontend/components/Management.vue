      ...
      <div class="container">
        ...
        <div class="columns has-text-centered">
          <div class="column is-4">
            ...
            <div class="block">
              <b-radio v-for="account in accounts" :key="account.id" v-model="radioFrom" native-value="default">
                {{ account.name }}
              </b-radio>
            </div>
          </div>
          ...
          <div class="column is-5">
            ...
            <div clv-if="accounts.length === 2" class="block">
              <b-radio v-for="account in accounts" :key="account.id" v-model="radioTo" native-value="default">
                {{ account.name }}
              </b-radio>
            </div>
          </div>
          <div class="column">
            <a style="margin-top:25px;" class="button"><i style="font-size:20px;" class="fa fa-arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="hero-body">
      <div class="container">
        ...
        <div class="columns">
          <div class="column">
            <b-field>
              <b-input v-model="nameInput" style="width:500px;" placeholder="Name of account" />
              <a class="button" v-on:click="newBankAccountName">Create account</a>
            </b-field>
          </div>
        </div>
      </div>
  ...
  <section class="hero is-white">
    <div class="hero-body">
      <div class="container">
        ...
        <div v-for="account in accounts" :key="account.id" class="list is-hoverable">
          <a class="list-item">
            ...
            <a class="button is-danger" v-on:click="deleteBankAccount(account.id)">Delete</a>
          </a>
        </div>
      </div>
    </div>
