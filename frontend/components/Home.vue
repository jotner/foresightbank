...
<div>
  ...
  <div class="box cta">
    <p class="has-text-centered">
      <i>"Foresight Bank is a smart, user-friendly and simple, yet effective platform. This bank is my go-to choice for all my finances."</i> - Victor Olsson, Sweden
    </p>
  </div>
    ...
    <div class="columns">
        ...
        <div class="card thumb">
          <div class="card-image">
            <figure class="image is-4by3">
              <img src="media/thumb1.jpg" alt="Girl">
            </figure>
            <div class="overlay">
      ...
      <div class="column">
        <div class="card thumb">
          <div class="card-image">
            <figure class="image is-4by3">
              <img src="media/thumb2.jpg" alt="Coins">
            </figure>
            <div class="overlay">
      ...
      <div class="column">
        <div class="card thumb">
          <div class="card-image">
            <figure class="image is-4by3">
              <img src="media/thumb3.jpg" alt="Man">
            </figure>
            <div class="overlay">
